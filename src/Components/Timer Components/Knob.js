...
<div class="fl-studio-envelope">
  <div class="fl-studio-envelope__visualizer"><svg class="envelope-visualizer" viewBox="0 0 300 100" preserveAspectRatio="xMinYMid slice">
  ...
  <div class="fl-studio-envelope__controls">
      <div class="fl-studio-envelope__control">
          <div class="knob-input fl-studio-envelope__knob envelope-knob delay"><svg class="knob-input__visual" viewBox="0 0 40 40">
      ...
      <div class="fl-studio-envelope__control">
          <div class="knob-input fl-studio-envelope__knob envelope-knob attack"><svg class="knob-input__visual" viewBox="0 0 40 40">
                  <circle class="focus-indicator" cx="20" cy="20" r="18" fill="#4eccff" filter="url(#glow)"></circle>
                  <circle class="indicator-ring-bg" cx="20" cy="20" r="18" fill="#353b3f" stroke="#23292d"></circle>
                  <path class="indicator-ring" d="M20,20Z" fill="#4eccff"></path>
                  <g class="dial">
      ...
      <div class="fl-studio-envelope__control">
          <div class="knob-input fl-studio-envelope__knob envelope-knob hold"><svg class="knob-input__visual" viewBox="0 0 40 40">
                  <circle class="focus-indicator" cx="20" cy="20" r="18" fill="#4eccff" filter="url(#glow)"></circle>
                  <circle class="indicator-ring-bg" cx="20" cy="20" r="18" fill="#353b3f" stroke="#23292d"></circle>
                  <path class="indicator-ring" d="M20,20Z" fill="#4eccff"></path>
                  <g class="dial">
      ...
      <div class="fl-studio-envelope__control">
          <div class="knob-input fl-studio-envelope__knob envelope-knob decay"><svg class="knob-input__visual" viewBox="0 0 40 40">
                  <circle class="focus-indicator" cx="20" cy="20" r="18" fill="#4eccff" filter="url(#glow)"></circle>
                  <circle class="indicator-ring-bg" cx="20" cy="20" r="18" fill="#353b3f" stroke="#23292d"></circle>
                  <path class="indicator-ring" d="M20,20Z" fill="#4eccff"></path>
                  <g class="dial">
      ...
      <div class="fl-studio-envelope__control">
          <div class="knob-input fl-studio-envelope__knob envelope-knob sustain"><svg class="knob-input__visual" viewBox="0 0 40 40">
                  <circle class="focus-indicator" cx="20" cy="20" r="18" fill="#4eccff" filter="url(#glow)"></circle>
                  <circle class="indicator-ring-bg" cx="20" cy="20" r="18" fill="#353b3f" stroke="#23292d"></circle>
                  <path class="indicator-ring" d="M20,20Z" fill="#4eccff"></path>
                  <g class="dial">
      ...
      <div class="fl-studio-envelope__control">
          <div class="knob-input fl-studio-envelope__knob envelope-knob release"><svg class="knob-input__visual" viewBox="0 0 40 40">
                  <circle class="focus-indicator" cx="20" cy="20" r="18" fill="#4eccff" filter="url(#glow)"></circle>
                  <circle class="indicator-ring-bg" cx="20" cy="20" r="18" fill="#353b3f" stroke="#23292d"></circle>
                  <path class="indicator-ring" d="M20,20Z" fill="#4eccff"></path>
                  <g class="dial">
  ...
  <div class="fl-studio-envelope__tension">
      ...
      <div class="knob-input fl-studio-envelope__knob tension-knob attack"><svg class="knob-input__visual" viewBox="0 0 40 40">
              <circle class="focus-indicator" cx="20" cy="20" r="18" fill="#4eccff" filter="url(#glow)"></circle>
              <circle class="indicator-ring-bg" cx="20" cy="20" r="18" fill="#353b3f" stroke="#23292d"></circle>
              <path class="indicator-ring" d="M20,20Z" fill="#4eccff"></path>
              <g class="dial">
      ...
      <div class="knob-input fl-studio-envelope__knob tension-knob decay"><svg class="knob-input__visual" viewBox="0 0 40 40">
              <circle class="focus-indicator" cx="20" cy="20" r="18" fill="#4eccff" filter="url(#glow)"></circle>
              <circle class="indicator-ring-bg" cx="20" cy="20" r="18" fill="#353b3f" stroke="#23292d"></circle>
              <path class="indicator-ring" d="M20,20Z" fill="#4eccff"></path>
              <g class="dial">
      ...
      <div class="fl-studio-envelope__label">tension</div>
      <div class="knob-input fl-studio-envelope__knob tension-knob release"><svg class="knob-input__visual" viewBox="0 0 40 40">
              <circle class="focus-indicator" cx="20" cy="20" r="18" fill="#4eccff" filter="url(#glow)"></circle>
              <circle class="indicator-ring-bg" cx="20" cy="20" r="18" fill="#353b3f" stroke="#23292d"></circle>
              <path class="indicator-ring" d="M20,20Z" fill="#4eccff"></path>
              <g class="dial">
